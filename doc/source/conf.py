# -*- coding: utf-8 -*-
#
# Tadbit documentation build configuration file, created by
...
sys.path.insert(0, os.path.abspath('../../pytadbit/'))
...
# pixels large.
html_favicon = 'pictures/Tadbit icon.png'
...
latex_documents = [
  ('index', 'Tadbit.tex', u'Tadbit Documentation',
   u'Davide Bau, Francois Serra, Guillaume Filion, Marc Marti', 'manual'),
]
