...
class IMPoptimizer(object):
    ...
    the generted models (generated by IMP, or lammps) and the input *C XXXnormalizedXXX
    contact map.

    :param experiment: an instance of the class pytadbit.experiment.Experiment
    :param start: first bin to model (bin number, starting from 0?)
    ...
    :param None container: restrains particle to be within a given object. 
       ...
       by hemispheres. This cylinder is defined by a radius, its height (using
       height=0 the container is a sphere), and the strenght (k) of the harmonic
    ...
    def __init__(self, experiment, start, end, n_models=500,
        ...
        (self.zscores, self.values, zeros) = experiment._sub_experiment_zscore(start, end)
        ...
        # For claruty, the order in which the optimized parameters are managed should be 
    ...
    def run_grid_search(self,
                        scale_range=0.01,
                        kbending_range=0.0, # Choose The values of kbending that should be explored by default!!!
        ...
        The range can be expressed as a list object 
