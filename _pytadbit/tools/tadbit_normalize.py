...
def run(opts):
    ...
    hic_data = load_hic_data_from_reads(root_path + mreads, reso)
    print 'Get poor bins...'
    print result_dir
    try:
        hic_data.filter_columns(draw_hist=True, perc_zero=99,
                                savefig=root_path + "results_{}/{}.{}.{}.{}.{}.bads.pdf".format(
                                    mapping, species, sample, index, reference, reso))
    except ValueError:
    ...
    out_bad = open(root_path + "results_{}/{}.{}.{}.{}.{}.bads.tsv".format(
        mapping, species, sample, index, reference, reso), 'w')
    ...
    print 'Cis/Trans ratio:', cis_trans_1
    print 'Cis/Trans ratio:', cis_trans_2
    print 'Cis/Trans ratio:', cis_trans_3
    print 'Cis/Trans ratio:', cis_trans_4
...
def populate_args(parser):
    ...
    glopts.add_argument('-r', '--resolution', dest='resolution', metavar="INT",
